...
$annotationReader = new Doctrine\Common\Annotations\SimpleAnnotationReader();//AnnotationReader();
...
$config->addCustomHydrationMode('tree', 'Gedmo\Tree\Hydrator\ORM\TreeObjectHydrator');
